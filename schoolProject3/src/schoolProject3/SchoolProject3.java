...
public class SchoolProject3 {
	
	static void register(Scanner scanner, ArrayList<Student> studentList, ArrayList<Professor> professorList, ArrayList<Manager> managerList, Scanner lineScanner) {
	...
	static void search(Scanner scanner, ArrayList<Student> studentList, ArrayList<Professor> professorList, ArrayList<Manager> managerList) {
	...
	static void delete(Scanner scanner, ArrayList<Student> studentList, ArrayList<Professor> professorList, ArrayList<Manager> managerList) {
	...
	static void list(ArrayList<Student> studentList, ArrayList<Professor> professorList, ArrayList<Manager> managerList) {
	...
	static void update(Scanner scanner, ArrayList<Student> studentList, ArrayList<Professor> professorList, ArrayList<Manager> managerList) {
	...
	public static void main(String[] args) {
		...
		if(cnt == 1) { //등록 버튼을 눌렀을 때
			 register(scanner, studentList, professorList, managerList, lineScanner);
			 if(cnt == 4) {
			...
			search(scanner, studentList, professorList, managerList);
			...
			delete(scanner, studentList, professorList, managerList);
			System.out.print("계속하시려면1, 종료하시려면0을 입력해주세요.");
			cnt = scanner.nextInt();
			if(cnt == 1) {
				continue;
			...
			list(studentList, professorList, managerList);
			System.out.print("계속하시려면1, 종료하시려면0을 입력해주세요.");
			cnt = scanner.nextInt();
			if(cnt == 1) {
				continue;
				...
				update(scanner, studentList, professorList, managerList);
				System.out.print("계속하시려면1, 종료하시려면0을 입력해주세요.");
				cnt = scanner.nextInt();
					if(cnt == 1) {
					continue;
