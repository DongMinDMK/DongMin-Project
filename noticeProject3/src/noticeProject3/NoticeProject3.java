...
public class NoticeProject3 {
	
	 void register(Scanner scanner, ArrayList<Person> personList) {
	 ...
	 void search(Scanner scanner, ArrayList<Person> personList){
	 ...
	 void delete(Scanner scanner, ArrayList<Person> personList) {
	 ...
	 void update(Scanner scanner, ArrayList<Person> personList) {
	 ...
	 void list(ArrayList<Person> personList) {
	...
	public static void main(String[] args) {
		...
		NoticeProject3 np3 = new NoticeProject3();
