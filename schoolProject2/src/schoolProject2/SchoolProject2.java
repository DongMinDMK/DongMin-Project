...
public class SchoolProject2 {
	static void register(int menu, Scanner scanner, String gubun, ArrayList<HashMap<String, String>> haksaList, Scanner lineScanner) { //등록 함수
		...
		menu = scanner.nextInt();
			if(menu == 1) { //학생
				...
				System.out.print("이름 : ");
				String irum1 = scanner.next();
				System.out.print("학번 : ");
				String hakbun1 = scanner.next();
				hm.put(gubun, "1");
				hm.put("age", age1);
				hm.put("irum", irum1);
				...
				System.out.print("이름 : ");
				String irum2 = scanner.next();
				System.out.print("과목 : ");
				String subject2 = lineScanner.nextLine();
				hm.put(gubun, "2");
				hm.put("age", age2);
				hm.put("irum", irum2);
				...
				HashMap<String, String> hm = new HashMap<String, String>();
					...
					System.out.print("이름 : ");
					String irum3 = scanner.next();
					System.out.print("부서 : ");
					String part3 = scanner.next();
					hm.put(gubun, "3");
					hm.put("age", age3);
					hm.put("irum", irum3);
					hm.put("part", part3);
	...
	static void search(Scanner scanner, ArrayList<HashMap<String,String>> haksaList, String gubun) { //찾기 함수
	...
	static void delete(Scanner scanner, ArrayList<HashMap<String,String>> haksaList, String gubun) { //삭제 함수
	...
	static void list(ArrayList<HashMap<String,String>> haksaList, String gubun) { //전체 출력 함수
	...
	static void update(Scanner scanner, ArrayList<HashMap<String,String>> haksaList, String gubun) { //수정 함수
	...
	public static void main(String[] args) {
		...
		if(cnt == 1) { //등록 버튼을 눌렀을 때
			register(cnt, scanner, gubun, haksaList, lineScanner);
			if(cnt== 4) {
			...
			search(scanner, haksaList, gubun);
			...
			delete(lineScanner, haksaList, gubun); //ctrl + space를 누르면 위에 메소드 파라미터에 있는거 한꺼번에 가져올 수 있음.
			System.out.print("계속하시려면1, 종료하시려면0을 입력해주세요.");
			cnt = scanner.nextInt();
			if(cnt == 1) {
				continue;
			...
			if(cnt == 1) {
			    ...
			    update(lineScanner, haksaList, gubun);
				System.out.print("계속하시려면1, 종료하시려면0을 입력해주세요.");
				cnt = scanner.nextInt();
					if(cnt == 1) {
					continue;
