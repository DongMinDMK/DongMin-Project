...
public class LoginProject2 {
	...
	static void signMethod(Scanner scanner, ArrayList<Member> memberList, Scanner lineScanner) { //회원가입 함수
	...
	static void searchMethod(Scanner scanner, ArrayList<Member> memberList) {
	...
	static void listMethod(ArrayList<Member> memberList) {
		Member member = new Member();
		for(int i=0; i<memberList.size(); i++) {
	...
	static void loginMethod(Scanner scanner, ArrayList<Member> memberList) {
		Member member = new Member();
	...
	static void deleteMethod(Scanner scanner, ArrayList<Member> memberList) {
	...
	static void updateMethod(ArrayList<Member> memberList, Scanner scanner, Scanner lineScanner) {
		Member member = new Member();
		for(int i=0; i<memberList.size(); i++) {
			member = memberList.get(i);
	...
	static void logoutMethod(Scanner scanner) {
